...
def main():
    ...
    parser.add_argument("--input", default=str(REPO_ROOT / "data" / "icdas" / "raw"))
    parser.add_argument("--output", default=str(REPO_ROOT / "data" / "icdas"))
    ...
    pd.DataFrame(ann_rows).to_csv(ann_dir / "annotations.csv", index=False)
